...
const WELL_FORMED = `<!doctype html><html><body>
  <div data-composition-id="amplifier-explainer" data-width="1920" data-height="1080" data-duration="60">
...
describe("lintCompositionHtml", () => {
  ...
  test("flags a composition missing data-composition-id", async () => {
    const broken = WELL_FORMED.replace(' data-composition-id="amplifier-explainer"', "");
