...
<html>
  <body>
    <div id="root" data-composition-id="amplifier-explainer" data-width="1920" data-height="1080" data-duration="${opts.rootDuration}">
      ${narration}
      ${scenes}
    </div>
  </body>
...
describe("extendCompositionDuration", () => {
  ...
  test("extends root, narration track, and last scene when narration overruns", () => {
    ...
    expect(result.html).toContain(
      'data-composition-id="amplifier-explainer" data-width="1920" data-height="1080" data-duration="72.5"',
    );
    expect(result.html).toContain(
...
<html><body>
  <div id="root" data-composition-id="amplifier-explainer" data-width="1920" data-height="1080" data-duration="60">
  ...
  <div data-composition-id='amplifier-explainer' data-width='1920' data-height='1080' data-duration='30'>
