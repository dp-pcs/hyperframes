# Amplify Composition Constraints

These constraints are non-negotiable. The Amplify worker will reject and retry any
...
- The composition MUST register a paused GSAP master timeline as:
  ...
  window.__timelines["amplify-explainer"] = tl; // tl = gsap.timeline({ paused: true })
  ```
