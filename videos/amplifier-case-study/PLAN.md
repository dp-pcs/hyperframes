# Amplifier Case Study Explainer — Implementation Plan
...
- `videos/amplifier-case-study/DESIGN.md` — visual system (palette, type, motion)
- `videos/amplifier-case-study/STORYBOARD.md` — beat-by-beat plan
- `videos/amplifier-case-study/SCRIPT.md` — narration script + voice settings
...
- File path: `videos/amplifier-case-study/master/compositions/beat-<N>-<slug>.html`
- Root element: `<div data-composition-id="amplifier-case-study-beat-<N>" data-start="0" data-duration="<seconds>" data-width="1920" data-height="1080">`
- Class prefix: `b<N>-` on every selector inside the beat (avoids collisions when merged into master)
- GSAP timeline: created paused, registered as `window.__timelines["amplifier-case-study-beat-<N>"] = tl`
...
- Create: `videos/amplifier-case-study/shared/tokens.css`
- Create: `videos/amplifier-case-study/shared/base.html` (reference template for beats)
...
[data-composition-id^="amplifier-case-study"] {
  position: absolute;
  inset: 0;
  background: var(--ink);
  color: var(--paper);
...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>amplifier-case-study beat (preview)</title>
  ...
  <body>
    ...
    <script>
      ...
      //   2) Registers it on window.__timelines["amplifier-case-study-beat-<N>"]
    </script>
  </body>
</html>
```
...
```bash
git add videos/amplifier-case-study/shared/
git commit -m "feat(videos/amplifier-case-study): add shared tokens and base template"
```
...
- Create: `videos/amplifier-case-study/master/compositions/beat-1-hook.html`
- Create: `videos/amplifier-case-study/master/snapshots/beat-1/` (will be populated by snapshot)
...
- The timeline MUST be registered on `window.__timelines["amplifier-case-study-beat-1"] = tl` (exact key).
...
window.__timelines["amplifier-case-study-beat-1"] = tl;
```
...
```bash
npx hyperframes lint videos/amplifier-case-study/master/compositions/beat-1-hook.html
```
...
```bash
npx hyperframes validate videos/amplifier-case-study/master/compositions/beat-1-hook.html
```
...
```bash
npx hyperframes snapshot videos/amplifier-case-study/master/compositions/beat-1-hook.html \
  --times 0,1.5,3.5,5.0,7.0 \
  --output videos/amplifier-case-study/master/snapshots/beat-1/
```
...
```bash
git add videos/amplifier-case-study/master/compositions/beat-1-hook.html
git commit -m "feat(videos/amplifier-case-study): build beat 1 — hook"
```
...
- Create: `videos/amplifier-case-study/master/compositions/beat-2-template-grid.html`
- Snapshots: `videos/amplifier-case-study/master/snapshots/beat-2/`
...
Root: `data-composition-id="amplifier-case-study-beat-2"`, `data-duration="10"`.

Layout (1920×1080 canvas):

- Top-right `mono-s` label: `amplifier / 2026-05-15` at top: 60px, right: 96px, JetBrains Mono 14px `--paper-muted`, letter-spacing 0.04em.
...
window.__timelines["amplifier-case-study-beat-2"] = tl;
```
...
```bash
npx hyperframes lint videos/amplifier-case-study/master/compositions/beat-2-template-grid.html
```
...
```bash
npx hyperframes validate videos/amplifier-case-study/master/compositions/beat-2-template-grid.html
```
...
```bash
npx hyperframes snapshot videos/amplifier-case-study/master/compositions/beat-2-template-grid.html \
  --times 0,1.0,2.5,4.5,6.5,9.0,9.9 \
  --output videos/amplifier-case-study/master/snapshots/beat-2/
```
...
```bash
git add videos/amplifier-case-study/master/compositions/beat-2-template-grid.html
git commit -m "feat(videos/amplifier-case-study): build beat 2 — template grid"
```
...
- Create: `videos/amplifier-case-study/master/compositions/beat-3-schema-reveal.html`
- Snapshots: `videos/amplifier-case-study/master/snapshots/beat-3/`
...
Root: `data-composition-id="amplifier-case-study-beat-3"`, `data-duration="13"`.
...
window.__timelines["amplifier-case-study-beat-3"] = tl;
```
...
```bash
npx hyperframes snapshot videos/amplifier-case-study/master/compositions/beat-3-schema-reveal.html \
  --times 0,1.5,3.0,4.5,7.0,9.5,11.0,13.0 \
  --output videos/amplifier-case-study/master/snapshots/beat-3/
```
...
```bash
git add videos/amplifier-case-study/master/compositions/beat-3-schema-reveal.html
git commit -m "feat(videos/amplifier-case-study): build beat 3 — schema reveal"
```
...
- Create: `videos/amplifier-case-study/master/compositions/beat-4-delete.html`
- Snapshots: `videos/amplifier-case-study/master/snapshots/beat-4/`
...
Root: `data-composition-id="amplifier-case-study-beat-4"`, `data-duration="10"`.
...
- Title bar (top 48px of terminal): three traffic-light dots (12px circles, 16px gap) at left, padding-left=20px, each in `--paper-dim`. Title text center: `~/amplifier — apps/web` in JetBrains Mono 14px `--paper-muted`.
...
window.__timelines["amplifier-case-study-beat-4"] = tl;
```
...
```bash
npx hyperframes snapshot videos/amplifier-case-study/master/compositions/beat-4-delete.html \
  --times 0,0.8,1.8,3.5,5.5,6.8,8.0,9.5 \
  --output videos/amplifier-case-study/master/snapshots/beat-4/
```
...
```bash
git add videos/amplifier-case-study/master/compositions/beat-4-delete.html
git commit -m "feat(videos/amplifier-case-study): build beat 4 — delete"
```
...
- Create: `videos/amplifier-case-study/master/compositions/beat-5-new-pipeline.html`
- Snapshots: `videos/amplifier-case-study/master/snapshots/beat-5/`
...
```bash
cat skills/hyperframes/SKILL.md skills/gsap/SKILL.md
grep -A 80 "BEAT 5 — NEW PIPELINE" videos/amplifier-case-study/STORYBOARD.md
```

- [ ] **Step 2: Author the beat HTML**

Root: `data-composition-id="amplifier-case-study-beat-5"`, `data-duration="18"`.
...
window.__timelines["amplifier-case-study-beat-5"] = tl;
...
```bash
npx hyperframes snapshot videos/amplifier-case-study/master/compositions/beat-5-new-pipeline.html \
  --times 0,1.5,3.0,4.5,6.0,8.0,10.5,13.0,17.0 \
  --output videos/amplifier-case-study/master/snapshots/beat-5/
```
...
```bash
git add videos/amplifier-case-study/master/compositions/beat-5-new-pipeline.html
git commit -m "feat(videos/amplifier-case-study): build beat 5 — new pipeline"
```
...
- Create: `videos/amplifier-case-study/master/compositions/beat-6-fallback.html`
- Snapshots: `videos/amplifier-case-study/master/snapshots/beat-6/`
...
Root: `data-composition-id="amplifier-case-study-beat-6"`, `data-duration="8"`.
...
window.__timelines["amplifier-case-study-beat-6"] = tl;
```
...
```bash
npx hyperframes snapshot videos/amplifier-case-study/master/compositions/beat-6-fallback.html \
  --times 0,0.8,1.5,2.5,4.0,7.0 \
  --output videos/amplifier-case-study/master/snapshots/beat-6/
```

- [ ] **Step 5: Commit**

```bash
git add videos/amplifier-case-study/master/compositions/beat-6-fallback.html
git commit -m "feat(videos/amplifier-case-study): build beat 6 — fallback"
```
...
- Create: `videos/amplifier-case-study/master/compositions/beat-7-bespoke-grid.html`
- Snapshots: `videos/amplifier-case-study/master/snapshots/beat-7/`
...
Root: `data-composition-id="amplifier-case-study-beat-7"`, `data-duration="12"`.

Same 3×2 grid layout as Beat 2 (cells 480×270, 40px gap, anchored 150px from top), but each cell is a **visibly distinct mini-composition**. Top-right label: `amplifier / 2026-05-19+`.
...
window.__timelines["amplifier-case-study-beat-7"] = tl;
...
```bash
npx hyperframes snapshot videos/amplifier-case-study/master/compositions/beat-7-bespoke-grid.html \
  --times 0,1.0,2.5,4.5,7.5,10.0,11.5 \
  --output videos/amplifier-case-study/master/snapshots/beat-7/
```
...
```bash
git add videos/amplifier-case-study/master/compositions/beat-7-bespoke-grid.html
git commit -m "feat(videos/amplifier-case-study): build beat 7 — bespoke grid"
```
...
- Create: `videos/amplifier-case-study/master/compositions/beat-8-lesson.html`
- Snapshots: `videos/amplifier-case-study/master/snapshots/beat-8/`
...
Root: `data-composition-id="amplifier-case-study-beat-8"`, `data-duration="9"`.
...
window.__timelines["amplifier-case-study-beat-8"] = tl;
```
...
```bash
npx hyperframes snapshot videos/amplifier-case-study/master/compositions/beat-8-lesson.html \
  --times 0,1.5,3.5,5.5,7.0,9.0 \
  --output videos/amplifier-case-study/master/snapshots/beat-8/
```

- [ ] **Step 5: Commit**

```bash
git add videos/amplifier-case-study/master/compositions/beat-8-lesson.html
git commit -m "feat(videos/amplifier-case-study): build beat 8 — lesson"
```
...
- Create: `videos/amplifier-case-study/narration/master-narration.mp3`
- Create: `videos/amplifier-case-study/narration/master-transcript.json`
...
```bash
npx hyperframes tts \
  --input videos/amplifier-case-study/narration/master-script.txt \
  --output videos/amplifier-case-study/narration/master-narration.mp3 \
  --voice am_eric \
  --speed 1.0 \
  --transcript videos/amplifier-case-study/narration/master-transcript.json
```
...
```bash
ls -la videos/amplifier-case-study/narration/
ffprobe -v error -show_entries format=duration videos/amplifier-case-study/narration/master-narration.mp3
```
...
```bash
afplay videos/amplifier-case-study/narration/master-narration.mp3
```
...
```bash
git add videos/amplifier-case-study/narration/
git commit -m "feat(videos/amplifier-case-study): generate master narration MP3"
```
...
- Create: `videos/amplifier-case-study/master/index.html`
...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Amplifier Case Study — Master</title>
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link
  ...
  <body>
    <div
      id="stage"
      data-composition-id="amplifier-case-study-master"
      data-start="0"
      data-duration="87"
      data-width="1920"
      data-height="1080"
    ...
    <script>
      ...
      // window.__timelines["amplifier-case-study-beat-N"] = tl
...
4. Move the beat's `<script>` block to the bottom of `<body>`. Each beat's script must self-defend: check `if (!document.querySelector('[data-composition-id="amplifier-case-study-beat-N"]')) return;` before running.
...
```bash
npx hyperframes lint videos/amplifier-case-study/master/index.html
```
...
```bash
npx hyperframes validate videos/amplifier-case-study/master/index.html
```
...
```bash
npx hyperframes preview videos/amplifier-case-study/master/index.html
```
...
```bash
git add videos/amplifier-case-study/master/index.html
git commit -m "feat(videos/amplifier-case-study): compose master cut index.html"
```
...
- Create: `videos/amplifier-case-study/renders/master-16x9.mp4`

- [ ] **Step 1: Render**

```bash
npx hyperframes render videos/amplifier-case-study/master/index.html \
  --output videos/amplifier-case-study/renders/master-16x9.mp4 \
  --width 1920 \
  --height 1080 \
  --fps 30
```
...
```bash
ls -la videos/amplifier-case-study/renders/
ffprobe -v error -show_entries format=duration -show_entries stream=width,height,codec_name videos/amplifier-case-study/renders/master-16x9.mp4
```
...
```bash
open videos/amplifier-case-study/renders/master-16x9.mp4
```
...
```bash
git add videos/amplifier-case-study/renders/master-16x9.mp4
git commit -m "feat(videos/amplifier-case-study): render master 16:9 MP4"
```
...
- Create: `videos/amplifier-case-study/narration/short-narration.mp3`
- Create: `videos/amplifier-case-study/narration/short-transcript.json`
...
```bash
npx hyperframes tts \
  --input videos/amplifier-case-study/narration/short-script.txt \
  --output videos/amplifier-case-study/narration/short-narration.mp3 \
  --voice am_eric \
  --speed 1.0 \
  --transcript videos/amplifier-case-study/narration/short-transcript.json
```

- [ ] **Step 3: Verify**

```bash
ffprobe -v error -show_entries format=duration videos/amplifier-case-study/narration/short-narration.mp3
```
...
```bash
git add videos/amplifier-case-study/narration/short-script.txt videos/amplifier-case-study/narration/short-narration.mp3 videos/amplifier-case-study/narration/short-transcript.json
git commit -m "feat(videos/amplifier-case-study): generate short narration MP3"
```
...
- Create: `videos/amplifier-case-study/short/compositions/sbeat-1-template-grid.html`
...
Root: `data-composition-id="amplifier-case-study-short-1"`, `data-duration="8"`, `data-width="1080"`, `data-height="1080"`.
...
```bash
npx hyperframes lint videos/amplifier-case-study/short/compositions/sbeat-1-template-grid.html
npx hyperframes validate videos/amplifier-case-study/short/compositions/sbeat-1-template-grid.html
npx hyperframes snapshot videos/amplifier-case-study/short/compositions/sbeat-1-template-grid.html \
  --times 0,1.5,3.5,6.0,7.8 \
  --output videos/amplifier-case-study/short/snapshots/sbeat-1/
```

- [ ] **Step 4: Commit**

```bash
git add videos/amplifier-case-study/short/compositions/sbeat-1-template-grid.html
git commit -m "feat(videos/amplifier-case-study): build short beat 1 — template grid"
```
...
- Create: `videos/amplifier-case-study/short/compositions/sbeat-2-delete.html`
...
Root: `data-composition-id="amplifier-case-study-short-2"`, `data-duration="6"`, `data-width="1080"`, `data-height="1080"`.
...
```bash
npx hyperframes snapshot videos/amplifier-case-study/short/compositions/sbeat-2-delete.html \
  --times 0,1.0,2.5,4.0,5.5 \
  --output videos/amplifier-case-study/short/snapshots/sbeat-2/
```

- [ ] **Step 4: Commit**

```bash
git add videos/amplifier-case-study/short/compositions/sbeat-2-delete.html
git commit -m "feat(videos/amplifier-case-study): build short beat 2 — delete"
```
...
- Create: `videos/amplifier-case-study/short/compositions/sbeat-3-bespoke-grid.html`
...
```bash
npx hyperframes snapshot videos/amplifier-case-study/short/compositions/sbeat-3-bespoke-grid.html \
  --times 0,1.5,3.5,5.5,7.5,9.5 \
  --output videos/amplifier-case-study/short/snapshots/sbeat-3/
```

- [ ] **Step 4: Commit**

```bash
git add videos/amplifier-case-study/short/compositions/sbeat-3-bespoke-grid.html
git commit -m "feat(videos/amplifier-case-study): build short beat 3 — bespoke grid"
```
...
- Create: `videos/amplifier-case-study/short/compositions/sbeat-4-lesson.html`
...
Root: `data-composition-id="amplifier-case-study-short-4"`, `data-duration="6"`, `data-width="1080"`, `data-height="1080"`.
...
```bash
npx hyperframes snapshot videos/amplifier-case-study/short/compositions/sbeat-4-lesson.html \
  --times 0,1.5,3.0,4.5,6.0 \
  --output videos/amplifier-case-study/short/snapshots/sbeat-4/
```

- [ ] **Step 4: Commit**

```bash
git add videos/amplifier-case-study/short/compositions/sbeat-4-lesson.html
git commit -m "feat(videos/amplifier-case-study): build short beat 4 — lesson"
```
...
- Create: `videos/amplifier-case-study/short/index.html`
...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Amplifier Case Study — Short</title>
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link
      href="https://fonts.googleapis.com/css2?family=Inter+Tight:wght@400;500;600&family=JetBrains+Mono:wght@400;500&family=Lora:ital,wght@1,600&display=swap"
  ...
  <body>
    <div
      id="stage"
      data-composition-id="amplifier-case-study-short"
      data-start="0"
      data-duration="30"
      data-width="1080"
      data-height="1080"
...
```bash
npx hyperframes lint videos/amplifier-case-study/short/index.html
npx hyperframes validate videos/amplifier-case-study/short/index.html
npx hyperframes preview videos/amplifier-case-study/short/index.html
```

- [ ] **Step 4: Commit**

```bash
git add videos/amplifier-case-study/short/index.html
git commit -m "feat(videos/amplifier-case-study): compose short cut index.html"
```
...
- Create: `videos/amplifier-case-study/renders/short-1x1.mp4`

- [ ] **Step 1: Render**

```bash
npx hyperframes render videos/amplifier-case-study/short/index.html \
  --output videos/amplifier-case-study/renders/short-1x1.mp4 \
  --width 1080 \
  --height 1080 \
  --fps 30
```
...
```bash
ffprobe -v error -show_entries format=duration -show_entries stream=width,height videos/amplifier-case-study/renders/short-1x1.mp4
```
...
```bash
open videos/amplifier-case-study/renders/short-1x1.mp4
```

- [ ] **Step 4: Commit**

```bash
git add videos/amplifier-case-study/renders/short-1x1.mp4
git commit -m "feat(videos/amplifier-case-study): render short 1:1 MP4"
```
...
- Create: `videos/amplifier-case-study/README.md`
...
````markdown
# Amplifier Case Study Explainer
...
```bash
git add videos/amplifier-case-study/README.md
git commit -m "docs(videos/amplifier-case-study): add project README"
```
...
- **Type consistency:** Composition IDs use consistent naming: `amplifier-case-study-beat-<N>` for master, `amplifier-case-study-short-<N>` for short cut. Timeline registration keys match. Beat class prefixes (`b1-` through `b8-`, `sb1-` through `sb4-`) are unique.
