# STORYBOARD — Amplify Case Study Explainer
...
1. Top-right `mono-s` label in `--paper-muted`: `amplify / 2026-05-15`.
...
1. Full-canvas terminal frame. `--ink-elevated` background, 1px `--ink-line`
   ...
   Terminal title bar: `~/amplify — apps/web`.
...
1. Top-right `mono-s` label: `amplify-video-worker / 2026-05-19`.
...
1. Top-right `mono-s` label: `amplify / 2026-05-19+`.
