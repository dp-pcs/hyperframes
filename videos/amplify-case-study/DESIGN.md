# DESIGN — Amplify Case Study Explainer
...
- GSAP master timeline is **paused** and registered on
  `window.__timelines["amplify-case-study-master"]` (and `-short` for the
...
- **Narration**: generated via the `hyperframes-media` skill or ElevenLabs
  directly. Files at `videos/amplify-case-study/narration/`.
